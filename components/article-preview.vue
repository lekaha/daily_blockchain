<template>
  <article>
    <img class="thumbnail"
      :src="article.fields.heroImage.fields.file.url + '?fit=scale&w=350&h=196'"
      :srcset="`${article.fields.heroImage.fields.file.url}?w=350&h=196&fit=fill 350w, ${article.fields.heroImage.fields.file.url}?w=1000&h=562&fit=fill 1000w, ${article.fields.heroImage.fields.file.url}?w=2000&h=1125&fit=fill 2000w`"
